...
def compute_costs(scenario2erpt=None, 
                  ...
                  bw_cc_tib_per_yr=0.6,
                  bw_filp_tib_per_yr=6, 
                  pdp_bandwidth_tib_per_yr=9,
    ...
    # bandwidth_1gbps_tib_per_yr = get_negligible_costs(bw_qap_tib_per_yr)
    ...
    filp_miner = {
        ...
        'bandwidth_cost': bw_filp_tib_per_yr,
    ...
    pdp_miner = {
        ...
        'power_cost': power_cost_tib_per_yr,
        'bandwidth_cost': pdp_bandwidth_tib_per_yr,
        'staff_cost': staff_cost_tib_per_yr,
        'sealing_cost': 0,
        'data_prep_cost': 0,
        'bd_cost': rd_bd_cost_tib_per_yr,
    ...
    pdp_exploit_miner = {
        ...
        'gas_cost': gas_cost_pdp_tib_per_yr,
        'power_cost': power_cost_tib_per_yr,
        'bandwidth_cost': bw_cc_tib_per_yr,
